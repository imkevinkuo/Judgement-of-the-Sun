...
public class FireworkPlayer {
    ...
    public static void fire(Location l, Type t, Color c, Boolean trail) {
    	...
    	final Firework firework = (Firework) l.getWorld().spawnEntity(loc, EntityType.FIREWORK);
		...
		Bukkit.getServer().getScheduler().scheduleSyncDelayedTask(Elementals.getPlugin(Elementals.class), new Runnable() {
            public void run() {
               	firework.detonate();
            }
        }, (2));
